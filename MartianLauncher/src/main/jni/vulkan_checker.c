...
Java_com_foxstudio_martianlauncher_utils_device_VulkanChecker_nativeSetLogCallback(
        JNIEnv *env,
        jclass clazz,
        jobject callback
) {
...
Java_com_foxstudio_martianlauncher_utils_device_VulkanChecker_nativeCheckVulkan(
        JNIEnv *env,
        jclass clazz,
        jstring jDriverPath,
        jstring jNativeDir,
    ...
    VkApplicationInfo appInfo = {
            ...
            .pApplicationName = "MartianLauncher",
...
#undef PUT_FEAT
    ...
    jclass capClass = (*env)->FindClass(env, "com/foxstudio/martianlauncher/utils/device/VulkanCapabilities");
