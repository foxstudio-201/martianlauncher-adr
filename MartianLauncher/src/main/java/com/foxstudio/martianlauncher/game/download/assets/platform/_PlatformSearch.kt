...
package com.foxstudio.martianlauncher.game.download.assets.platform

import android.util.Log
import com.foxstudio.martianlauncher.game.download.assets.mapExceptionToMessage
import com.foxstudio.martianlauncher.BuildKeys
import com.foxstudio.martianlauncher.game.download.assets.platform.curseforge.CURSE_TOOLS_API
import com.foxstudio.martianlauncher.game.download.assets.platform.curseforge.CurseForgeSearcher
import com.foxstudio.martianlauncher.game.download.assets.platform.curseforge.MCIM_CURSEFORGE_API
import com.foxstudio.martianlauncher.game.download.assets.platform.modrinth.MCIM_MODRINTH_API
import com.foxstudio.martianlauncher.game.download.assets.platform.modrinth.ModrinthSearcher
import com.foxstudio.martianlauncher.game.download.assets.utils.localizedModSearchKeywords
...
import com.foxstudio.martianlauncher.utils.network.isInterruptedIOException
...
private val curseToolsSearcher = CurseForgeSearcher(
    api = CURSE_TOOLS_API,
    source = "CurseTools"
)
...
fun mirroredCurseForgeSource(
    ...
    val officialSource = curseForgeSearcher.takeIf { BuildKeys.CURSEFORGE_API.isNotBlank() }
    return when (source) {
        MirrorSourceType.OFFICIAL_FIRST ->
            listOfNotNull(officialSource, mirrorSource, curseToolsSearcher)
        MirrorSourceType.MIRROR_FIRST ->
            listOfNotNull(mirrorSource, officialSource, curseToolsSearcher)
    }
}
