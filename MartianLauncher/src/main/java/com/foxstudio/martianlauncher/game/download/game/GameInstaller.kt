...
package com.foxstudio.martianlauncher.game.download.game

import android.content.Context
import android.content.Intent
import com.foxstudio.martianlauncher.R
import com.foxstudio.martianlauncher.context.GlobalContext
import com.foxstudio.martianlauncher.coroutine.Task
import com.foxstudio.martianlauncher.coroutine.TaskFlowExecutor
import com.foxstudio.martianlauncher.coroutine.TitledTask
import com.foxstudio.martianlauncher.coroutine.addTask
import com.foxstudio.martianlauncher.coroutine.buildPhase
...
import com.foxstudio.martianlauncher.game.addons.modloader.cleanroom.CleanroomVersion
import com.foxstudio.martianlauncher.game.addons.modloader.fabriclike.FabricLikeVersion
import com.foxstudio.martianlauncher.game.addons.modloader.forgelike.ForgeLikeVersion
import com.foxstudio.martianlauncher.game.addons.modloader.forgelike.neoforge.NeoForgeVersion
import com.foxstudio.martianlauncher.game.addons.modloader.modlike.ModVersion
import com.foxstudio.martianlauncher.game.download.assets.platform.mcim.mapMCIMMirrorUrls
import com.foxstudio.martianlauncher.game.download.game.cleanroom.getCleanroomDownloadTask
import com.foxstudio.martianlauncher.game.download.game.cleanroom.targetTempCleanroomInstaller
import com.foxstudio.martianlauncher.game.download.game.fabric.getFabricLikeCompleterTask
import com.foxstudio.martianlauncher.game.download.game.fabric.getFabricLikeDownloadTask
import com.foxstudio.martianlauncher.game.download.game.forge.getForgeLikeAnalyseTask
import com.foxstudio.martianlauncher.game.download.game.forge.getForgeLikeDownloadTask
import com.foxstudio.martianlauncher.game.download.game.forge.getForgeLikeInstallTask
import com.foxstudio.martianlauncher.game.download.game.forge.isNeoForge
import com.foxstudio.martianlauncher.game.download.game.forge.targetTempForgeLikeInstaller
import com.foxstudio.martianlauncher.game.download.game.optifine.getOptiFineDownloadTask
import com.foxstudio.martianlauncher.game.download.game.optifine.getOptiFineInstallTask
import com.foxstudio.martianlauncher.game.download.game.optifine.getOptiFineModsDownloadTask
import com.foxstudio.martianlauncher.game.download.game.optifine.targetTempOptiFineInstaller
import com.foxstudio.martianlauncher.game.download.jvm_server.JVMSocketServer
import com.foxstudio.martianlauncher.game.download.jvm_server.JvmService
import com.foxstudio.martianlauncher.game.path.getGameHome
import com.foxstudio.martianlauncher.game.version.download.BaseMinecraftDownloader
import com.foxstudio.martianlauncher.game.version.download.MinecraftDownloader
import com.foxstudio.martianlauncher.game.version.installed.VersionConfig
...
import com.foxstudio.martianlauncher.utils.file.copyDirectoryContents
import com.foxstudio.martianlauncher.utils.logging.Logger
import com.foxstudio.martianlauncher.utils.network.downloadFromMirrorListSuspend
import com.foxstudio.martianlauncher.utils.network.withSpeedReport
