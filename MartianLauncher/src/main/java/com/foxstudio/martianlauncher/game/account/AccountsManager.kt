...
import com.foxstudio.martianlauncher.database.AppDatabase
import com.foxstudio.martianlauncher.game.account.auth_server.data.AuthServer
import com.foxstudio.martianlauncher.game.account.auth_server.data.AuthServerDao
...
object AccountsManager {
    ...
    private fun checkLimit(): Boolean {
        //MartianLauncher: 始终允许离线账号（不限制非中国大陆地区）
        //MartianLauncher: always allow offline accounts (no regional/genuine restriction)
        return false
    }
