...
package com.foxstudio.martianlauncher.game.plugin.renderer

import android.content.Context
import android.content.pm.ApplicationInfo
import com.foxstudio.martianlauncher.R
import com.foxstudio.martianlauncher.game.plugin.ApkPlugin
import com.foxstudio.martianlauncher.game.plugin.ApkPluginManager
import com.foxstudio.martianlauncher.game.plugin.cacheAppIcon
import com.foxstudio.martianlauncher.game.renderer.Renderers

/**
 * FCL、MartianLauncher 渲染器插件，同时支持使用本地渲染器插件
    ...
    override fun parseApkPlugin(
        ...
        if (info.flags and ApplicationInfo.FLAG_SYSTEM == 0) {
            ...
            if (
                ...
                metaData.getBoolean("martianRendererPlugin", false)
            ) {
