...
package com.foxstudio.martianlauncher.ui.screens.content.download.assets.search
...
import com.foxstudio.martianlauncher.game.download.assets.platform.PlatformDisplayLabel
import com.foxstudio.martianlauncher.game.download.assets.platform.PlatformFilterCode
import com.foxstudio.martianlauncher.game.download.assets.platform.PlatformSearchFilter
import com.foxstudio.martianlauncher.game.download.assets.platform.PlatformSearchResult
import com.foxstudio.martianlauncher.game.download.assets.platform.navigatePage
import com.foxstudio.martianlauncher.game.download.assets.platform.nextPage
import com.foxstudio.martianlauncher.game.download.assets.platform.previousPage
import com.foxstudio.martianlauncher.game.download.assets.platform.searchAssets
import com.foxstudio.martianlauncher.game.download.assets.utils.ModTranslations
import com.foxstudio.martianlauncher.game.download.assets.utils.searchMcMods
...
import com.foxstudio.martianlauncher.game.versioninfo.popularVersions
import com.foxstudio.martianlauncher.ui.base.BaseScreen
import com.foxstudio.martianlauncher.ui.screens.content.DownloadPlatformBarState
import com.foxstudio.martianlauncher.ui.screens.content.LocalDownloadPlatformBar
import com.foxstudio.martianlauncher.ui.screens.NestedNavKey
import com.foxstudio.martianlauncher.ui.screens.TitledNavKey
import com.foxstudio.martianlauncher.ui.screens.content.download.assets.elements.AssetsPage
import com.foxstudio.martianlauncher.ui.screens.content.download.assets.elements.ResultListLayout
import com.foxstudio.martianlauncher.ui.screens.content.download.assets.elements.SearchAssetsState
import com.foxstudio.martianlauncher.ui.screens.content.download.assets.elements.SearchFilter
...
fun SearchAssetsScreen(
    ...
    val changePlatform: (Platform) -> Unit = { platform ->
    ...
    val platformBarHolder = LocalDownloadPlatformBar.current
    LaunchedEffect(platformBarHolder, viewModel.searchPlatform, enablePlatform) {
        platformBarHolder?.value = DownloadPlatformBarState(
            platform = viewModel.searchPlatform,
            enabled = enablePlatform,
    ...
    BaseScreen(
        ...
        Row {
            ...
            SearchFilter(
                ...
                enablePlatform = enablePlatform && platformBarHolder == null,
